                ...
                <div className="w-full lg:w-3/4 bg-[#0B61AA] p-6 sm:p-4 rounded-lg shadow-lg" style={{ maxWidth: '994px', height: 'auto' }}>
                    ...
                    {currentQuestion && (
                      <>
                        ...
                        <div className="relative mb-6 sm:mb-4 bg-white p-4 sm:p-2 rounded-[15px] shadow">
                          {/* Overlay untuk Akses Terkunci */}
                          <div className="absolute inset-0 backdrop-blur-md bg-white/50 rounded-[15px] z-10 flex items-center justify-center">
                            <div className="text-center">
                              ...
                              {/* Pesan dan Tombol Akses */}
                              <p className="text-sm mb-4">
                                Klik di bawah ini untuk mendapatkan akses soal
                              </p>
                          ...
                          {/* Teks Pertanyaan */}
                          <p className="text-lg font-poppins mb-6 sm:mb-4 z-0">
                          ...
                          {questions[currentOption - 1]?.questionPhoto && (
                            <img
                              ...
                              alt={`Pertanyaan ${questions[currentOption - 1]?.questionNumber}`}
                              className="h-64 w-64 aspect-square rounded-lg object-cover mx-auto my-3 z-0"
                            />
                          )}
                          ...
                          {currentQuestion.options.map((option) => (
                            <div
                              key={option.id}
                              className="mb-4 sm:mb-2 bg-white p-4 sm:p-2 font-poppins rounded-lg shadow-lg z-0"
                            >
                              {/* Input Radio */}
                              <input
                                type="radio"
